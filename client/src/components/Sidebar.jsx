...
const navItems = [
    ...
    {to: '/ai/remove-images' , label: 'Remove Background' ,  Icon: Eraser},
    {to: '/ai/remove-object' , label: 'Remove Object' ,  Icon: Scissors},
    {to: '/ai/review-resume' , label: 'Review Resume' ,  Icon: FileText},
    {to: '/ai/generate-videos' , label: 'Video Generation' ,  Icon: Image},
...
const Sidebar = ({sidebar , setSidebar}) => {
    ...
    const {signOut , openUserProfile} = useClerk()
      ...
      if (!isLoaded) {
    return null // or show a small loading state
  }
  ...
  return (
    ...
    ${sidebar? 'translate-x-0' : 'max-sm:-translate-x-full'} transition-all duration-300 ease-in-out`}>
      <div className='my-7 w-full'>
        <img src={user.imageUrl} alt='User Avatar' className='w-12 rounded-full mx-auto'></img>
